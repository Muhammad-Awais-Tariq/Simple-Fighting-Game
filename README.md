# MadLibs
Its a fighting game created in python.

## Features
- Randomly generates a number.
- Asks the user for the number
- The game continues till the enemy health is 0 or the user health is 0
...
## Notes
- A simple terminal based number game and it has fixed range.
